...
export class BusinessTypesController {
  ...
  @ApiResponse({ status: 404, description: "Business type not found" })
  update(@Param("id", ParseIntPipe) id: number, @Body() updateBusinessTypeDto: UpdateBusinessTypeDto) {
  ...
  @ApiResponse({ status: 404, description: "Business type not found" })
  updateStatus(@Param("id", ParseIntPipe) id: number, @Body() updateBusinessTypeStatusDto: UpdateBusinessTypeStatusDto) {
  ...
  bulkUpdateStatus(@Body() body: { ids: number[]; status: BusinessTypeStatus }) {
